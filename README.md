...
## Introduction
This repository contains an analysis of the collegeIncome dataset. A codebook for the dataset is given below:
...
## Purpose
The purpose of our analysis is to find out whether there is a significant association between college major category and income.

## Analysis
The analysis is stored as college_major_analysis.rds in this repository
